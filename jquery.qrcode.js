/**
 * Copyright (c) 2017, Jinghui Liao  (1498262377@qq.com).
 *
...
for (function (a) {
        a.fn.qrcode = function (b) {
            ...
            return "string" == typeof b && (b = {
                ...
                cheight: b.height + 80,
                cwidth: b.width + 40,
                cstyle: "width:" + b.cwidth + "px;height:" + b.cheight + "px;",
                content: "",
                ...
                console.log('cheight = ' + b.cheight);
                for (a.addData(b.text), a.make(), c = document.createElement("canvas"),
                    c.width = b.cwidth, c.height = b.cheight, c.style = b.cstyle, d = c.getContext("2d"),
                    d.fillStyle = b.background, d.fillRect(0, 0, b.cwidth, b.cheight),
                ...
                d.stroke();
                d.textAlign = "center"
                d.fillText(b.content, Math.floor(b.width / 2 + b.border), Math.floor(b.height +b.border*3));
                return c
            }, this.each(function () {
                var e = c();
                a(e).appendTo(this)
